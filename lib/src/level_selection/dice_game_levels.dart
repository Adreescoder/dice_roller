const diceGameLevels = [
  DiceGameLevel(number: 1, dices: 1, sides: 1),
  DiceGameLevel(number: 2, dices: 1, sides: 2),
  DiceGameLevel(number: 3, dices: 1, sides: 3),
  DiceGameLevel(number: 4, dices: 1, sides: 4),
  DiceGameLevel(number: 5, dices: 1, sides: 5),
  DiceGameLevel(number: 6, dices: 1, sides: 1),
  DiceGameLevel(number: 7, dices: 2, sides: 2),
  DiceGameLevel(number: 8, dices: 3, sides: 3),
  DiceGameLevel(number: 9, dices: 4, sides: 4),
  DiceGameLevel(number: 10, dices: 5, sides: 5),
  DiceGameLevel(number: 11, dices: 6, sides: 6),
];
...
class DiceGameLevel {
  ...
  }) : /* assert(dices >= 3 && dices <= 6,
            "The number of dices should be minimum 3 and maximum 6."),
        assert(sides >= 2 && dices <= 20,
            "The number of sides should be minimum 2 and maximum 20."), */
        assert(
            (achievementIdAndroid != null && achievementIdIOS != null) ||
                (achievementIdAndroid == null && achievementIdIOS == null),
            'Either both iOS and Android achievement ID '
