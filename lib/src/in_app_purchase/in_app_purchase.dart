...
import 'package:dice_roller/src/in_app_purchase/ad_removal.dart';
...
class InAppPurchaseController extends ChangeNotifier {
  ...
  Future<void> buy() async {
    ...
    var response = await inAppPurchaseInstance
    ...
    var productDetails = response.productDetails.single;
    _log.info('Making the purchase');
    var purchaseParam = PurchaseParam(productDetails: productDetails);
    try {
      var success = await inAppPurchaseInstance.buyNonConsumable(
      ...
      _log.severe('Problem with calling '
          'inAppPurchaseInstance.buyNonConsumable(): $e');
    }
  }
  ...
  /// Subscribes to the [InAppPurchase.purchaseStream].
  void subscribe() {
  ...
  Future<bool> _verifyPurchase(PurchaseDetails purchaseDetails) async {
    ...
    // TODO(mitul): verify the purchase.
